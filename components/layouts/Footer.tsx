    ...
    <div className={`pb-8 px-4 pt-10 sm:pt-18 ${wrapperBgColor}`}>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 gap-5">
          ...
          {isBlueButton ? (
            <Button btnText="Download App" onClick={() => router.push('/ourapps')} />
          ) : isBlackText ? (
            <Button btnText="Download App" onClick={() => router.push('/ourapps')} isBlackText />
          ) : isWhiteButton ? (
            <Button btnText="Download App" onClick={() => router.push('/ourapps')} isWhite />
          ) : (
            <Button btnText="Download App" onClick={() => router.push('/ourapps')} isWhite />
          )}
        </div>
