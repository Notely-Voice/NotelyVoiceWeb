const GreetingPhone = () => {
  ...
  return (
    <div className="mt-20 -mb-32 min-h-[560px] xl:min-h-[600px] w-90 lg:w-[320px] xl:w-90 bg-[var(--blueBg)] border-8 border-white rounded-[60px] xl:rounded-[70px] py-5 px-5 flex flex-col justify-start items-center relative overflow-hidden">
