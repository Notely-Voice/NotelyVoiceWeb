...
const RecordShareToolCanvas = () => {
  return (
    <div className="py-1.5 sm:py-3 px-2 sm:px-4 border-2 sm:border-4 border-dashed border-[#3E45FB] bg-white rounded-2xl sm:rounded-4xl min-h-[90px] sm:min-h-[180px] flex flex-col justify-between gap-2 sm:gap-4 min-w-[110px] sm:min-w-[220px] w-[130%] -ml-[15%]">
      <div className="flex justify-center py-2 sm:py-4">
        <Voice color="var(--blueBg)" barWidth={5} barHeight="h-6 sm:h-12" className="sm:hidden" />
