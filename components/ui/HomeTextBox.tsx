...
const HomeTextBox = () => {
  ...
  return (
    <div className="border-[5px] border-black h-max min-w-max bg-[#F0FEFF] py-1.5 sm:py-2.5 xl:py-4 px-3 xl:px-5 rounded-2xl sm:rounded-[20px] overflow-hidden">
      <div className="flex flex-col xl:gap-1">
        {lines.map((text, idx) => (
          <p
            key={idx}
            className={`animate__animated font-medium text-[10px] sm:text-sm lg:text-xs xl:text-base sm:leading-[18px] tracking-normal text-[#3E45FB] ${
