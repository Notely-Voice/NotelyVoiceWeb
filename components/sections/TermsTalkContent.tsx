...
This agreement governs the use of Notely Talk, an AI voice keyboard and dictation application created by Notely Talk, Inc. as a service, provided "AS IS".
...
By using Notely Talk, you agree to:

- **Protect your device security:** You are responsible for maintaining the security of your device
- **Take accountability for all dictated content:** All content you create using the Application is your responsibility
...
- Create content that violates the rights of others or applicable laws

Violation of these prohibited uses may result in immediate termination of your license to use the Application.

## 5. Intellectual Property

The Application and its original content, features, and functionality are owned by Notely Talk, Inc. and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
...
- The accuracy, reliability, or completeness of transcriptions
...
- Errors or inaccuracies in transcriptions
- Any content dictated or created using the Application

## 8. Data and Privacy

Notely Talk does not store any voice recordings, transcriptions, or dictated content on our servers.

- Your dictated text is processed through OpenAI's API for transcription purposes
- No data is retained by Notely Talk on our servers
- All transcribed text goes directly to the application you're using
- You are responsible for any data stored in third-party applications where you use Notely Talk

## 9. Third-Party Service (OpenAI)

Notely Talk uses OpenAI's Whisper API to transcribe your voice to text in real-time. By using this Application, you acknowledge that:

- Audio is sent to OpenAI's servers for processing
- OpenAI does not use API data to train their models by default
- Audio is not retained by Notely Talk
- You are subject to OpenAI's terms of service and usage policies
- The Service Provider is not responsible for OpenAI's service availability or accuracy

For more information about OpenAI's terms and privacy practices, visit https://openai.com/policies

## 10. Changes to Terms

Notely Talk reserves the right to modify or replace these Terms of Service at any time. Changes will take effect immediately upon posting.
...
We reserve the right to suspend or terminate your access to the Application at any time, without notice, for conduct that we believe:

- Violates these Terms of Service
- Is harmful to other users or the Application
...
**By using Notely Talk, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.**
`;

const TermsTalkContent = () => {
  ...
  const sections = [
    ...
    { id: "8", title: "8. Data and Privacy" },
    { id: "9", title: "9. Third-Party Service (OpenAI)" },
    { id: "10", title: "10. Changes to Terms" },
    { id: "11", title: "11. Termination" },
...
export default TermsTalkContent;
