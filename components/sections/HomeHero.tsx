...
const HomeHero = () => {
  return (
    <div className="pt-3.5 px-[36px] flex flex-col justify-center items-center relative">
      <div className="wrapper bg-[var(--blueBg)] pt-12 xl:pt-20 pb-5 xl:pb-[50px] pl-16 lg:pl-12 xl:pl-20 pr-10 rounded-[40px] flex flex-col lg:flex-row justify-center gap-6 z-20 relative">
        <SectionIntro
        ...
        Perfect for students, pros & accessibility."
          ...
          textStyle="max-w-[320px] lg:max-w-[400px] xl:max-w-[509px] mb-8! lg:mb-[45px]! text-xl lg:text-2xl! lg:leading-[130%]! lg:mb-7!"
          isBtnWhite
