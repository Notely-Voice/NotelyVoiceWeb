...
const HomeHero = () => {
  return (
    <div className="pt-3.5 px-[36px] flex flex-col justify-center items-center relative">
      <div className="wrapper bg-[var(--blueBg)] pt-12 xl:pt-20 pb-0 lg:pb-[50px] pl-16 lg:pl-12 xl:pl-20 pr-10 rounded-[40px] flex flex-col lg:flex-row justify-center gap-6 z-20 relative">
        <SectionIntro
        ...
        Perfect for students, pros & accessibility."
          headingStyle="max-w-[420px]! md:mb-4 lg:mb-8 lg:max-w-[400px]! xl:max-w-[500px]! text-[68px] lg:text-[60px]"
          textStyle="max-w-[490px]! lg:max-w-[400px]! xl:max-w-[509px]! mb-8! lg:mb-[45px]! text-xl lg:text-2xl! lg:leading-[130%]! lg:mb-7!"
          isBtnWhite
