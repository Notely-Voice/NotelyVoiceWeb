...
interface StartSpeakingProps {
  bgColor?: "black" | "white" | "blue"; // Dynamic background based on page
...
const StartSpeaking: React.FC<StartSpeakingProps> = ({
  ...
  return (
    <div className={`px-6 xl:px-9 flex justify-center items-center relative`}>
      <div
        className={`${bgClass} rounded-[30px] sm:rounded-[40px] wrapper px-6 xl:px-9 pt-6 sm:pt-16  flex flex-col justify-center items-center overflow-hidden`}>
        {/* Desktop Layout */}
        <div className="hidden md:flex flex-col justify-center items-center w-full relative">
          ...
          <div className="">
            <SectionIntro
              ...
              headingStyle="text-[52px]! lg:text-[70px]! max-w-full mb-4! lg:mb-6!"
            />
          </div>

          {/* Decorative Dotted Lines */}
          <Image src={icons.curly_reverse_dotted_line_white} alt="dotted line"
          ...
          <div className="relative">
            ...
            <div
              ...
              <div
                className="text-sm font-semibold tracking-[-3%] font-instrument whitespace-nowrap"
              >
                Listening
              </div>
              <Image src={icons.voice_blue} alt="voice" width={20} height={20}/>
            </div>
            ...
            <div
              ...
              <div
                className="text-sm text-[var(--blueBg)] font-semibold tracking-[-3%] font-instrument whitespace-nowrap"
              >
                Transcribed
              </div>
              <Image src={icons.check_filled_blue} alt="check" width={20} height={20}/>
            </div>
        ...
        <div className="md:hidden flex flex-col justify-center items-center w-full">
          ...
          <div className="relative">
            ...
            <div
              ...
              <div
                className="text-[10px] sm:text-sm font-semibold tracking-[-3%] font-instrument whitespace-nowrap"
              >
                Listening
              </div>
              <Image src={icons.voice_blue} alt="voice" className="w-4 h-4 sm:w-5 sm:h-5"/>
            </div>
            ...
            <div
              ...
              <div
                className="text-[10px] sm:text-sm text-[var(--blueBg)] font-semibold tracking-[-3%] font-instrument whitespace-nowrap"
              >
                Transcribed
              </div>
              <Image src={icons.check_filled_blue} alt="check" className="w-4 h-4 sm:w-5 sm:h-5"/>
            </div>
