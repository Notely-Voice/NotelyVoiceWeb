        ...
        <div className="bg-[#F0FEFF] rounded-[20px] sm:rounded-[30px] px-6 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-12">
          <div className="space-y-4">
            <p className="text-black text-base sm:text-lg lg:text-lg leading-relaxed">
              Welcome to Notely Talk! These Terms of Service govern your use of our AI voice keyboard and dictation application. By accessing or using Notely Talk, you agree to be bound by these terms.
            </p>
            <p className="text-black text-base sm:text-lg lg:text-lg leading-relaxed">
